...
3. 启动Spark Shell
    ...
    ![Spark Shell Web UI](./img/1/spark-shell-web-ui.png)
...
3. 配置WSL
    ...
    + Spark Worker Web UI
        ![Spark Worker Web UI](./img/1/spark-worker-web-ui.png)
    + Spark Shell Web UI
        ![Spark Shell Web UI](./img/1/spark-shell-web-ui.png)
...
![Spark Master Web UI](./img/1/spark-master-ui-completed-apps.png)
